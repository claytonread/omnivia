...
class MemoryRepository:
    ...
    def create(self, memory: Memory) -> Memory:
        ...
        self.db.execute(
            ...
            INSERT INTO memories (
                id, workspace_id, content, source_type, source_reference, source_description,
    ...
    def search(
        ...
        if workspace_id is not None:
            workspace_condition = "AND workspace_id = ?"
            params.append(workspace_id)
    ...
    def get_by_workspace(self, workspace_id: str) -> list[Memory]:
        """Find all memories in a workspace."""
        cursor = self.db.execute(
            """
            SELECT * FROM memories
            WHERE workspace_id = ?
