...
from omnivia_memory.ingestion.extractors import BaseExtractor, MarkdownExtractor, TextExtractor
...
class IngestionPipeline:
    ...
    def ingest_file(self, file_path: Path, workspace_id: str | None = None) -> IngestResult:
        ...
        try:
            ...
            if self.source_repository:
                existing = self.source_repository.get_by_path(str(file_path), workspace_id)
    ...
    def ingest_directory(
        ...
        for file_info in files:
            result = self.ingest_file(file_info.path, workspace_id=workspace_id)
